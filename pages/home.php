    ...
    <div class="cars">
        <?php for ($i = 4; $i <= 11; $i++) : ?>
            <div class="car-details">
                ...
                <img src="/car_renting/assets/images/products/Car (<?= $i ?>).svg" alt="Car <?= $i ?>">
                <div class="car-specification">
                    <span><img src="/car_renting/assets/images/icons/gas-station.svg" alt=""> 90l</span>
                    <span><img src="/car_renting/assets/images/icons/car.svg" alt=""> Schakel</span>
                    <span><img src="/car_renting/assets/images/icons/profile-2user.svg" alt=""> 2 Personen</span>
                </div>
                <div class="rent-details">
                    <span><span class="font-weight-bold">€249,00</span> / dag</span>
                    <a href="/car_renting/pages/car-detail.php?id=<?= $i ?>" class="button-primary">Bekijk nu</a>
                </div>
            </div>
        <?php endfor; ?>
    </div>
